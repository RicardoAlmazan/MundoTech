...
function oculta(laimg,num){
    if(num != num1)
    {
        ...
        if(img1 == "")
        {
            ...
            document.getElementById(num1).classList.remove('oculta');
            document.getElementById(num1).classList.add('espera');
            },500);
        }
        else
        {
            ...
            img2 = laimg;
            window.setTimeout(function(){
            document.getElementById(num2).classList.remove('oculta');
            document.getElementById(num2).classList.add('espera');
            },500);
            if(img1 == img2)
            {
                img1 = "";
            ...
            else
            {
                ...
                img2 = "";
                window.setTimeout(function(){
                document.getElementById(num1).classList.remove('espera');
                document.getElementById(num1).classList.add('esconde'); 
                document.getElementById(num2).classList.remove('espera');
                document.getElementById(num2).classList.add('esconde');
                },500);
                document.getElementById(num2).classList.remove('esconde');
                document.getElementById(num1).classList.remove('esconde');
            }
        }
    }
    else
