...
<%    //creamos un obj de la clase cAlumno
    ...
    String tblAlumnos = alums.todosHtml();
...
<script>
    function cancelaReg()
    {
        parent.self.window.location = "indexMain.jsp";
    }
</script>
</head>
...
<!--[if gt IE 8]><!--> <html lang=""> <!--<![endif]-->
    ...
    <center><a  class="btn btn-default" href="?xAcc=1"><img  src="https://cdn2.iconfinder.com/data/icons/windows-8-metro-style/512/add_user.png" class="img-thumbnail" width="100px"/><p>Nuevo Alumno</p></a></center>
